...
(define (populate-players rooms)
  (create-violent-person 'ben-bitdiddle (pick-random rooms)
			    2 2 1)
  (create-violent-person 'alyssa-p-hacker (pick-random rooms)
			    2 2 2)
  (create-violent-person 'prof-yuret (pick-random rooms)
			    1 2 1)
  (create-violent-person 'comp200-student (pick-random rooms)
			    2 1 2)
  (create-violent-person 'lambda-man (pick-random rooms)
			    3 3 1)
